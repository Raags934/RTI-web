  ...
  export class IdeaView implements OnInit, OnDestroy {
    ...
    private buildForm() {
      this.form = this.fb.group({
        ...
        funding_status: new FormControl(null, Validators.required),
        funding_source: new FormControl(null, Validators.required),
      });
    ...
    onCancel() {
      // TODO: implement cancel logic for funding
      console.log('Cancel funding');
    }

    onFunding() {
      this.showFundingPopup = true;
    }

    onConfirmFunding() {
      // TODO: implement confirm funding logic
      console.log('Confirm funding');
      this.showFundingPopup = false;
    }
